...
| #   | Problem                                                                      | Difficulty | Company  | SQL Pattern | Solution                                 |
| --- | ---------------------------------------------------------------------------- | ---------- | -------- | ----------- | ---------------------------------------- |
| 001 | [App Click-through Rate](https://datalemur.com/questions/click-through-rate) | Easy       | Facebook | Aggregation | [View](Easy/001_app_click_through_rate.md) |
| 002 | [Page With No Likes](https://datalemur.com/questions/sql-page-with-no-likes) | Easy       | Facebook | Anti Join   | [View](Easy/002_page_with_no_likes.md)   |
| 003 | [Average Post Hiatus (Part 1)](https://datalemur.com/questions/sql-average-post-hiatus-1) | Easy       | Facebook | Grouping    | [View](Easy/003_average_post_hiatus_1.md)  |
